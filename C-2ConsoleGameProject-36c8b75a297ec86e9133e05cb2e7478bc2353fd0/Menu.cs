...
static class Menu
{
    ...
    private static int menuX =Console.WindowWidth/2; // the X axis of the start of the menu
    private static int menuY = Console.WindowHeight/2; // the Y axis of the start of the menu
